...
i7 = imresize(Mask_img2, 0.1);
i8 = imresize(Mask_img3, 0.1);
i9 = imresize(Mask_img4, 0.1);
i10 = imresize(Mask_img5, 0.1);
i11 = imresize(Mask_img6, 0.1);
...
N=701;
[Xs,Ys,Zs] = meshgrid(1:1:N, 1:1:N, 1:2:10);
[Xo,Yo,Zo] = meshgrid(1:1:N, 1:1:N, 1:1:10);
