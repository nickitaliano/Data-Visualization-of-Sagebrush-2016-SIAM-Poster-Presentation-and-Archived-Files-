...
% and visulaization development code (Working Code)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%%
%Import Mike's imagesand mask (convert to grayscale and double precision)
...
%%
%rename masks and multiply arrays to create image of branch w/o bark
...
%%
%Rescale the images for easier preprocessing
delta_w = 154; 
delta_1 = 121;
delta_2 = 109;
delta_3 = 110;
...
%%
% Clear non essential items for computational effiecieny (Katherine's idea)
...
%%
%Katherine's Padding and Translation
...
% colormap('gray')
%%
% Read in new images and change variables
...
clear T_img11
%%
% Write Variables to save as images
